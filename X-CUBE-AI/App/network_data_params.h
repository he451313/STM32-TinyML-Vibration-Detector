...
#define AI_NETWORK_DATA_ACTIVATIONS_SIZES \
  { 856, }
#define AI_NETWORK_DATA_ACTIVATIONS_SIZE     (856)
#define AI_NETWORK_DATA_ACTIVATIONS_COUNT    (1)
#define AI_NETWORK_DATA_ACTIVATION_1_SIZE    (856)



#define AI_NETWORK_DATA_WEIGHTS_SIZES \
  { 86168, }
#define AI_NETWORK_DATA_WEIGHTS_SIZE         (86168)
#define AI_NETWORK_DATA_WEIGHTS_COUNT        (1)
#define AI_NETWORK_DATA_WEIGHT_1_SIZE        (86168)
